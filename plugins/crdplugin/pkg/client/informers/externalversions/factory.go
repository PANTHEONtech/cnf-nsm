...
import (
	...
	pantheontech "go.cdnf.io/cnf-nsm/plugins/crdplugin/pkg/client/informers/externalversions/pantheontech"
...
type SharedInformerFactory interface {
	...
	Pantheon() pantheontech.Interface
}

func (f *sharedInformerFactory) Pantheon() pantheontech.Interface {
	return pantheontech.New(f, f.namespace, f.tweakListOptions)
}
