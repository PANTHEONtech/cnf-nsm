...
func (in *CNFConfigurationList) DeepCopyInto(out *CNFConfigurationList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]CNFConfiguration, len(*in))
		for i := range *in {
...
func (in *CNFConfigurationSpec) DeepCopyInto(out *CNFConfigurationSpec) {
	*out = *in
	if in.ConfigItems != nil {
		...
		*out = make([]contivppiov1.ConfigurationItem, len(*in))
		copy(*out, *in)
	}
	return
}
